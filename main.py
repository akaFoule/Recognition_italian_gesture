...
class Window(tk.Frame):
    ...
    def init_window(self):
        self.master.title("Traduttore gesti italiani")
        self.font0 = tk_font.Font(self, size=12)
        self.font = tk_font.Font(self, size=14)
        self.style = Style()
        ...
        frame1.pack(fill=X)
        input_button = tk.Button(frame1, text = 'Cartella di input', bg='#b3b3b3', font=self.font,
        ...
        frame2.pack(fill=X)
        inputvideo_button = tk.Button(frame2, text = 'Input file video', bg="#b3b3b3", font=self.font,
        ...
        frame3.pack(fill=X)
        output_button = tk.Button(frame3, text = 'Cartella di output', bg="#b3b3b3", font=self.font,
        ...
        frame9.pack(fill=X)
        outputvideo_button = tk.Button(frame9, text = 'Output file video', bg="#b3b3b3", font=self.font,
        ...
        mediapipe_button = tk.Button(frame4, text = "Avvio Hands Mediapipe", bg="#b3b3b3", font=self.font,
                                     command=self.hand_mediapipe)
        mediapipe_button.grid(row=0, column=1)
        outputvideo_button = tk.Button(frame4, text = "Apri output video", bg="#b3b3b3", font=self.font,
        ...
        frame5.pack(fill=X)
        predict_button = tk.Button(frame5, text = "Riconosci 1 gesto", bg="#b3b3b3", font=self.font, command=self.sign_predict)
        ...
        frame6.pack(fill=X)
        sequence_button = tk.Button(frame6, text = "Riconosci una sequenza", bg="#b3b3b3", font=self.font,
        ...
        frame8.pack(fill=X)
        quit_button = tk.Button(frame8, text = 'Chiudi', font=self.font0, command = self.close_window, bg="#b3b3b3")
    ...
    # FUNZIONE PER VISUALIZZARE IL FILE VIDEO IN INPUT
    ...
    # FUNZIONE PER VISUALIZZARE IL FILE VIDEO DI OUTPUT
    ...
    # AVVIO DEL PROCESSO DI MEDIAPIPE
    ...
    # FUNZIONE PER PREDIRRE UN SEGNO
        ...
        for file in listfile:
            ...
            for text in textlist:
                ...
                with open(textname, mode='r') as t:
                    ...
                    print("Il file txt è di lunga durata: " + str(len(number1)))
                    print("Perché il file txt è il secondo: " + str(len(number2)))
                    print("===================================")
    ...
    def sequence_predict(self):
        global x1_test, x2_test, x3_test, y3hat, predictions3, result
